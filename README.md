<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/75d3bed9-a24f-4fe5-a7a7-2adb8d4ce173" /># Bài tập 02 - Odoo + PostgreSQL
...
<!-- Chèn ảnh: phiếu WH/IN/00006 trạng thái Done -->
...
<!-- Chèn ảnh: báo cáo Inventory hiện 3 sách với On Hand -->

Vào **Reporting → Move Analysis** → chuyển sang dạng biểu đồ để xem phân tích giao dịch:

<!-- Chèn ảnh: biểu đồ Move Analysis -->
...
<!-- Chèn ảnh: trình duyệt mở odoo.taphamdinhhoa.io.vn hiện màn hình login Odoo -->
